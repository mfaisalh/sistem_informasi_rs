        ...
        <div class="card-body">
            ...
            <form action="{{ route('pasien.update',$pasien->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="noreg" value="{{ $pasien->noreg }}" class="form-control" placeholder="noreg">
                    @error('noreg')
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="nama" value="{{ $pasien->nama }}" class="form-control" placeholder="nama">
                    @error('nama')
                        <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="tgl_lahir" value="{{ $pasien->tgl_lahir }}" class="form-control" placeholder="tgl_lahir">
                    @error('tgl_lahir')
                        <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                    @enderror
                </div>
